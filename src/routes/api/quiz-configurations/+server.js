...
export async function POST({ request, locals }) {
	...
	try {
		...
		// Validate song list access for authenticated users updating their own quizzes.
		// Skip validation when creating a new quiz (fork/remix) — the original quiz was already
		// allowed to reference those lists, and access is re-checked at play-time anyway.
		if (session && user && existingQuizId) {
