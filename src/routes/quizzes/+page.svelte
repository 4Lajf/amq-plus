								...
								>
									...
									<div class="block">
										...
										<div class="flex flex-wrap items-center gap-2">
											...
											{/if}
											{#if quiz.quiz_metadata?.guessTime}
												{@const gt = quiz.quiz_metadata.guessTime.guessTime}
												{@const egt = quiz.quiz_metadata.guessTime.extraGuessTime}
												<Badge
													variant="outline"
						...
						<div class="mb-4">
							<div class="flex flex-wrap items-center gap-2">
								...
								{#if selectedQuiz.quiz_metadata.songTypes && songTypesMode}
									...
									{#if selectedQuiz.quiz_metadata.songTypes.openings?.enabled && openingsValue}
										<Badge variant="outline" class="text-xs text-green-600" href="">
											🎵 OP
											{#if songTypesMode === 'count'}
												{#if selectedQuiz.quiz_metadata.songTypes.openings.minCount !== undefined && selectedQuiz.quiz_metadata.songTypes.openings.maxCount !== undefined && selectedQuiz.quiz_metadata.songTypes.openings.random && selectedQuiz.quiz_metadata.songTypes.openings.minCount < selectedQuiz.quiz_metadata.songTypes.openings.maxCount}
									...
									{/if}
									{#if selectedQuiz.quiz_metadata.songTypes.endings?.enabled && endingsValue}
										<Badge variant="outline" class="text-xs text-blue-600" href="">
											🎵 ED
											{#if songTypesMode === 'count'}
												{#if selectedQuiz.quiz_metadata.songTypes.endings.minCount !== undefined && selectedQuiz.quiz_metadata.songTypes.endings.maxCount !== undefined && selectedQuiz.quiz_metadata.songTypes.endings.random && selectedQuiz.quiz_metadata.songTypes.endings.minCount < selectedQuiz.quiz_metadata.songTypes.endings.maxCount}
									...
									{/if}
									{#if selectedQuiz.quiz_metadata.songTypes.inserts?.enabled && insertsValue}
										<Badge variant="outline" class="text-xs text-purple-600" href="">
											🎵 IN
											{#if songTypesMode === 'count'}
												{#if selectedQuiz.quiz_metadata.songTypes.inserts.minCount !== undefined && selectedQuiz.quiz_metadata.songTypes.inserts.maxCount !== undefined && selectedQuiz.quiz_metadata.songTypes.inserts.random && selectedQuiz.quiz_metadata.songTypes.inserts.minCount < selectedQuiz.quiz_metadata.songTypes.inserts.maxCount}
