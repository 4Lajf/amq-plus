...
<div class="min-h-screen bg-linear-to-br from-rose-50 to-pink-50 py-12">
	<div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
				...
				<div class="space-y-8">
					{#each steps as step}
						<div class="flex items-start space-x-4">
							<div
								class="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-linear-to-br from-rose-500 to-pink-600 text-sm font-semibold text-white"
							>
								{step.number}
							</div>
							<div class="flex-1">
		...
		<div class="rounded-xl border border-rose-200/50 bg-linear-to-r from-rose-100 to-pink-100 p-6">
			<div class="flex items-start space-x-4">
				<div class="shrink-0 rounded-lg bg-rose-200 p-2">
				...
				<div>
					...
					<ul class="space-y-2 text-sm text-rose-800">
						<li class="flex items-start space-x-2">
							<div class="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-rose-600"></div>
