...
<Dialog bind:open>
	<DialogContent class="sm:max-w-[500px]" portalProps={{}}>
		...
		{:else}
			<Tabs bind:value={activeTab} class="w-full">
				<TabsList class="grid w-full grid-cols-2">
					<TabsTrigger class="" value="view">Play Link</TabsTrigger>
					<TabsTrigger class="" value="edit">Edit Link</TabsTrigger>
				</TabsList>
				...
				<TabsContent value="view" class="space-y-4 py-4">
					...
					<div class="space-y-2">
						<Label class="">Play Link</Label>
						<div class="flex gap-2">
							<Input class="w-full" type="text" value={viewUrl} readonly />
							<Button
								class=""
								variant="outline"
								size="icon"
				...
				<TabsContent value="edit" class="space-y-4 py-4">
					...
					<div class="space-y-2">
						...
						<div class="flex gap-2">
							<Input class="w-full" type="text" value={editUrl} readonly />
							<Button
								class=""
								variant="outline"
								size="icon"
		...
		<DialogFooter class="">
			<Button class="" variant="outline" disabled={false} onclick={() => (open = false)}>
				Close
			</Button>
		</DialogFooter>
	</DialogContent>
