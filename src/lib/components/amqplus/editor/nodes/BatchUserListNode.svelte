<script lang="ts">
	/**
	 * Batch User List Source Node Component
	 * Displays a source node for importing anime lists from multiple users simultaneously.
	...
	import BatchUserListDialog from '../dialogs/BatchUserListDialog.svelte';
	...
	// Handle value changes from dialog
...
<div
	class="batch-user-list-node relative rounded-lg border-2 bg-white p-3 shadow-md transition-all hover:shadow-lg"
	style="
...
>
	...
	<!-- Input Handle (left side) - Batch User List nodes can be chained -->
...
<style>
	.batch-user-list-node {
		font-family: inherit;
	}

	.batch-user-list-node:focus {
