<script lang="ts">
	/**
	 * Song List Source Node Component
	 * Displays a source node for selecting base song pools (entire database, user lists, or public lists).
	...
	import SongListDialog from '../dialogs/SongListDialog.svelte';
...
<div
	class="song-list-node relative rounded-lg border-2 bg-white p-3 shadow-md transition-all hover:shadow-lg"
	style="
...
>
	...
	<!-- Input Handle (left side) - Song List nodes can be chained -->
