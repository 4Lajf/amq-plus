...
import { ANIME_SCORE_DEFAULT_SETTINGS } from '$lib/utils/defaultNodeSettings.js';
import { ValidationResult } from '$lib/utils/validationFramework.js';
import { validateRange, validateValue } from '$lib/utils/commonValidators.js';
import { formatScoreRange } from '$lib/utils/commonDisplayUtils.js';
...
function validateAnimeScore(value, context) {
  ...
  // Anime scores are typically 1-10
  if (min < 1 || max > 10) {
    result.addWarning('Anime score range is typically 1-10');
  }
