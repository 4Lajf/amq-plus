...
class FilterRegistryClass {
   ...
   * @returns {import('$lib/utils/validationFramework.js').ValidationResult}
   */
   ...
   * @returns {Object.<string, import('$lib/utils/nodeCategories.js').NodeDefinition>}
   */
  toNodeDefinitions() {
    /** @type {Object.<string, import('$lib/utils/nodeCategories.js').NodeDefinition>} */
    const definitions = {};
